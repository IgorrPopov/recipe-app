...
const imgNameArr = [];
const defaultUsersIDs = [
  '5fe06fc2ec384b3de893982f',
  '5fe06feaec384b3de8939835',
  '5fe070086f9b5d4224376d4b',
  '5fe0703ffea07728f4798ce4',
  '5fe07069d430860560a8515b',
];
...
router.post(
  ...
  async (req, res) => {
    ...
    //   const randomOwnerIdString =
    //     defaultUsersIDs[Math.floor(Math.random() * defaultUsersIDs.length)];
    //   const randomOwnerId = mongoose.Types.ObjectId(randomOwnerIdString);

    //   try {
    //     const recipe = new Recipe({ ...validRecipe, owner: randomOwnerId });
    //     await recipe.save();
    //     return `${imgNameArr.length + 1}) Recipe: "${title}" loaded!`;
    //   } catch (e) {
    //     return 'Error: ' + e.message;
    //   }
    // }

    // while (imgNameArr.length < 10000) {
